...
**Mandatory rules:**
- Every row must cite a real measurement source — qa-engineer's report for functional, auditor's report for stability+code metrics, your own diff review for security+architecture.
